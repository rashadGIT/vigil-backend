...
export class DeathCertificateController {
  constructor(
    private readonly deathCertificateService: DeathCertificateService,
  ) {}
  ...
  @ApiResponse({
    status: 409,
    description: 'Death certificate already exists for this case',
  })
  ...
  @ApiResponse({
    status: 404,
    description: 'No death certificate record found',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
