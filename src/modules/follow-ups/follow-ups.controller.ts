...
export class FollowUpsController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Schedule grief follow-up emails for a contact on a case',
  })
  @ApiResponse({
    status: 201,
    description: 'Follow-ups scheduled (1w, 1mo, 6mo, 1yr)',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Returns array of follow-up records',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
