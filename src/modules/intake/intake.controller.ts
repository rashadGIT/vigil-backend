...
export class IntakeController {
  ...
  @Post(':slug')
  @ApiOperation({ summary: 'Submit a public intake form for a tenant (no auth required)' })
  @ApiResponse({ status: 201, description: 'Intake submitted — case, contact, tasks, and follow-ups created' })
